...
class ItemQuery extends ElementQuery
{
    ...
    protected function beforePrepare(): bool
    {
        ...
        $this->subQuery->leftJoin('{{%elements_sites}} element_content', '[[wishlist_items.elementId]] = [[element_content.elementId]] AND [[wishlist_items.elementSiteId]] = [[element_content.siteId]]');
